...
public class Cipher {
    ...
    public String decryptCipheredText(String cipherText, String password) throws UnsupportedEncodingException{
        int plainTextLength = cipherText.length();
        StringBuffer sb = new StringBuffer();
        if (plainTextLength < 16) {
        ...
        decrypt();
        return new String(org.apache.commons.codec.binary.Base64.decodeBase64(getCipherText().getBytes()));
    }
    ...
    public String getCipherText() throws UnsupportedEncodingException{
        StringBuffer sb = new StringBuffer();
        sb.append("");
        ...
        int l = sb.length();
        return new String(org.apache.commons.codec.binary.Base64.encodeBase64(sb.toString().getBytes("UTF-8")));
    }
}
